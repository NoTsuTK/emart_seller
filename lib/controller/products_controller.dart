...
class ProductsController extends GetxController {
  ...
  uploadProduct({context}) async {
    var store = firestore.collection(productionCollection).doc();
    await store.set({
      'is_featured': false,
      'p_category': categoryvalue.value,
      'p_subcategory': subcategoryvalue.value,
      'p_colors': FieldValue.arrayUnion([Colors.red.value, Colors.brown.value]),
      'p_imgs': FieldValue.arrayUnion(pImgLink),
  ...
  removeProduct(docId) async {
    await firestore.collection(productionCollection).doc(docId).delete();
  }
}
